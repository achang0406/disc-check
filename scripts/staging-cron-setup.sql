-- Wave 1a: pg_cron jobs for staging (pickup_frisbee schema).
-- Project URL is staging; run once after schema.sql on iunqmpxp.

DO $$
DECLARE
  job_id BIGINT;
  project_url TEXT := 'https://iunqmpxpwhybqyfxcsdt.supabase.co';
  service_key TEXT;
BEGIN
